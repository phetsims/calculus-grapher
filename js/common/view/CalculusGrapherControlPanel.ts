...
export default class CalculusGrapherControlPanel extends Panel {
  ...
  public constructor( curveManipulationProperties: CurveManipulationProperties,
    ...
    const options = optionize<CalculusGrapherControlPanelOptions, SelfOptions, PanelOptions>()( {
      ...
      accessibleHeading: CalculusGrapherFluent.a11y.controlPanel.accessibleHeadingStringProperty
    }, providedOptions );
    ...
    const pushButtonGroup = new CurvePushButtonGroup( interactiveCurveProperty, activeCurveManipulatorProperty,
      predictEnabledProperty, options.hasSmoothButton, options.tandem.createTandem( 'pushButtonGroup' ) );
