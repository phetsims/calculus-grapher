...
export default class GraphNode extends Node {
  ...
  protected constructor( graphType: GraphType,
    ...
    // The primary graph does not have the zoom feature for the y-axis. If you'd like to add the zoom feature
    // to the primary graph in the future, remove the if-statement that surrounds this block.
