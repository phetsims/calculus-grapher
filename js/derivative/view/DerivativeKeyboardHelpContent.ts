...
export default class DerivativeKeyboardHelpContent extends TwoColumnKeyboardHelpContent {
...
calculusGrapher.register( 'DerivativeKeyboardHelpContent', DerivativeKeyboardHelpContent );