...
addToMapIfDefined( 'a11y_referenceLineScrubber_accessibleObjectResponseFirstDerivative', 'a11y.referenceLineScrubber.accessibleObjectResponseFirstDerivativeStringProperty' );
addToMapIfDefined( 'a11y_referenceLineScrubber_accessibleObjectResponseIntegral', 'a11y.referenceLineScrubber.accessibleObjectResponseIntegralStringProperty' );
addToMapIfDefined( 'a11y_referenceLineScrubber_accessibleObjectResponseIntegralFirstDerivative', 'a11y.referenceLineScrubber.accessibleObjectResponseIntegralFirstDerivativeStringProperty' );
addToMapIfDefined( 'a11y_referenceLineScrubber_accessibleObjectResponseFirstDerivativeSecondDerivative', 'a11y.referenceLineScrubber.accessibleObjectResponseFirstDerivativeSecondDerivativeStringProperty' );
...
const CalculusGrapherFluent = {
  ...
  a11y: {
    ...
    slopeOfTangentAccordionBox: {
      accessibleHelpTextCollapsedStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_slopeOfTangentAccordionBox_accessibleHelpTextCollapsed', _.get( CalculusGrapherStrings, 'a11y.slopeOfTangentAccordionBox.accessibleHelpTextCollapsedStringProperty' ) ),
    ...
    referenceLineScrubber: {
      ...
      accessibleObjectResponseFirstDerivative: new FluentPattern<{ firstDerivativeValue: FluentVariable, variable: FluentVariable, x: FluentVariable, y: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineScrubber_accessibleObjectResponseFirstDerivative', _.get( CalculusGrapherStrings, 'a11y.referenceLineScrubber.accessibleObjectResponseFirstDerivativeStringProperty' ), [{"name":"firstDerivativeValue"},{"name":"variable"},{"name":"x"},{"name":"y"}] ),
      accessibleObjectResponseIntegral: new FluentPattern<{ integralValue: FluentVariable, variable: FluentVariable, x: FluentVariable, y: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineScrubber_accessibleObjectResponseIntegral', _.get( CalculusGrapherStrings, 'a11y.referenceLineScrubber.accessibleObjectResponseIntegralStringProperty' ), [{"name":"integralValue"},{"name":"variable"},{"name":"x"},{"name":"y"}] ),
      accessibleObjectResponseIntegralFirstDerivative: new FluentPattern<{ firstDerivativeValue: FluentVariable, integralValue: FluentVariable, variable: FluentVariable, x: FluentVariable, y: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineScrubber_accessibleObjectResponseIntegralFirstDerivative', _.get( CalculusGrapherStrings, 'a11y.referenceLineScrubber.accessibleObjectResponseIntegralFirstDerivativeStringProperty' ), [{"name":"firstDerivativeValue"},{"name":"integralValue"},{"name":"variable"},{"name":"x"},{"name":"y"}] ),
      accessibleObjectResponseFirstDerivativeSecondDerivative: new FluentPattern<{ firstDerivativeValue: FluentVariable, secondDerivativeValue: FluentVariable, variable: FluentVariable, x: FluentVariable, y: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineScrubber_accessibleObjectResponseFirstDerivativeSecondDerivative', _.get( CalculusGrapherStrings, 'a11y.referenceLineScrubber.accessibleObjectResponseFirstDerivativeSecondDerivativeStringProperty' ), [{"name":"firstDerivativeValue"},{"name":"secondDerivativeValue"},{"name":"variable"},{"name":"x"},{"name":"y"}] )
    },
