...
const CalculusGrapherFluent = {
  ...
  a11y: {
    ...
    _comment_13: new FluentComment( {"comment":"Controls visibility of curves on a graph, and the accessible name is specific to the graph.","associatedKey":"curveVisibilityToggleButton"} ),
