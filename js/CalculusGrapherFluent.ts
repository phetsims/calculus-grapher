...
const CalculusGrapherFluent = {
  ...
  a11y: {
    ...
    tangentTool: {
      ...
      accessibleObjectResponse: new FluentPattern<{ absoluteFirstDerivativeValue: FluentVariable, firstDerivativeValue: FluentVariable, sign: number | 'zero' | 'positive' | 'negative' | TReadOnlyProperty<number | 'zero' | 'positive' | 'negative'>, variable: FluentVariable, x: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_tangentTool_accessibleObjectResponse', _.get( CalculusGrapherStrings, 'a11y.tangentTool.accessibleObjectResponseStringProperty' ), [{"name":"absoluteFirstDerivativeValue"},{"name":"firstDerivativeValue"},{"name":"sign","variants":[{"type":"number","value":"zero"},"positive","negative"]},{"name":"variable"},{"name":"x"}] )
    },
    referenceLineTool: {
