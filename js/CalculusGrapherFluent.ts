...
addToMapIfDefined( 'a11y_referenceLineScrubber_accessibleObjectResponse', 'a11y.referenceLineScrubber.accessibleObjectResponseStringProperty' );
...
const CalculusGrapherFluent = {
  ...
  a11y: {
    ...
    referenceLineScrubber: {
      ...
      accessibleObjectResponse: new FluentPattern<{ firstDerivativeValue: FluentVariable, integralValue: FluentVariable, secondDerivativeValue: FluentVariable, variable: FluentVariable, x: FluentVariable, y: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineScrubber_accessibleObjectResponse', _.get( CalculusGrapherStrings, 'a11y.referenceLineScrubber.accessibleObjectResponseStringProperty' ), [{"name":"firstDerivativeValue"},{"name":"integralValue"},{"name":"secondDerivativeValue"},{"name":"variable"},{"name":"x"},{"name":"y"}] )
    },
