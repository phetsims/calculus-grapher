...
const CalculusGrapherFluent = {
  ...
  a11y: {
    ...
    referenceLineTool: {
      ...
      accessibleObjectResponse: new FluentPattern<{ derivativeValue: FluentVariable, graphSet: 'primaryDerivative' | 'integralPrimary' | 'integralPrimaryDerivative' | 'primaryDerivativeSecondDerivative' | TReadOnlyProperty<'primaryDerivative' | 'integralPrimary' | 'integralPrimaryDerivative' | 'primaryDerivativeSecondDerivative'>, integralValue: FluentVariable, secondDerivativeValue: FluentVariable, variable: FluentVariable, x: FluentVariable, y: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponseStringProperty' ), [{"name":"derivativeValue"},{"name":"graphSet","variants":["primaryDerivative","integralPrimary","integralPrimaryDerivative","primaryDerivativeSecondDerivative"]},{"name":"integralValue"},{"name":"secondDerivativeValue"},{"name":"variable"},{"name":"x"},{"name":"y"}] )
    },
    areaUnderCurveTool: {
