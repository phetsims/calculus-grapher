...
addToMapIfDefined( 'a11y_referenceLineTool_accessibleObjectResponse_patterns', 'a11y.referenceLineTool.accessibleObjectResponse.patternsStringProperty' );
addToMapIfDefined( 'a11y_referenceLineTool_accessibleObjectResponse_phrases_primaryPhrases_primaryValue', 'a11y.referenceLineTool.accessibleObjectResponse.phrases.primaryPhrases.primaryValueStringProperty' );
addToMapIfDefined( 'a11y_referenceLineTool_accessibleObjectResponse_phrases_primaryPhrases_primaryUndefined', 'a11y.referenceLineTool.accessibleObjectResponse.phrases.primaryPhrases.primaryUndefinedStringProperty' );
addToMapIfDefined( 'a11y_referenceLineTool_accessibleObjectResponse_phrases_primaryPhrases_primaryHidden', 'a11y.referenceLineTool.accessibleObjectResponse.phrases.primaryPhrases.primaryHiddenStringProperty' );
addToMapIfDefined( 'a11y_referenceLineTool_accessibleObjectResponse_phrases_primaryPhrases_predictValue', 'a11y.referenceLineTool.accessibleObjectResponse.phrases.primaryPhrases.predictValueStringProperty' );
addToMapIfDefined( 'a11y_referenceLineTool_accessibleObjectResponse_phrases_primaryPhrases_predictUndefined', 'a11y.referenceLineTool.accessibleObjectResponse.phrases.primaryPhrases.predictUndefinedStringProperty' );
addToMapIfDefined( 'a11y_referenceLineTool_accessibleObjectResponse_phrases_primaryPhrases_predictHidden', 'a11y.referenceLineTool.accessibleObjectResponse.phrases.primaryPhrases.predictHiddenStringProperty' );
addToMapIfDefined( 'a11y_referenceLineTool_accessibleObjectResponse_phrases_primaryPhrases_bothCurves', 'a11y.referenceLineTool.accessibleObjectResponse.phrases.primaryPhrases.bothCurvesStringProperty' );
addToMapIfDefined( 'a11y_referenceLineTool_accessibleObjectResponse_phrases_integralPhrases_numberValue', 'a11y.referenceLineTool.accessibleObjectResponse.phrases.integralPhrases.numberValueStringProperty' );
addToMapIfDefined( 'a11y_referenceLineTool_accessibleObjectResponse_phrases_integralPhrases_hidden', 'a11y.referenceLineTool.accessibleObjectResponse.phrases.integralPhrases.hiddenStringProperty' );
addToMapIfDefined( 'a11y_referenceLineTool_accessibleObjectResponse_phrases_derivativePhrases_numberValue', 'a11y.referenceLineTool.accessibleObjectResponse.phrases.derivativePhrases.numberValueStringProperty' );
addToMapIfDefined( 'a11y_referenceLineTool_accessibleObjectResponse_phrases_derivativePhrases_undefined', 'a11y.referenceLineTool.accessibleObjectResponse.phrases.derivativePhrases.undefinedStringProperty' );
addToMapIfDefined( 'a11y_referenceLineTool_accessibleObjectResponse_phrases_derivativePhrases_hidden', 'a11y.referenceLineTool.accessibleObjectResponse.phrases.derivativePhrases.hiddenStringProperty' );
addToMapIfDefined( 'a11y_referenceLineTool_accessibleObjectResponse_phrases_secondDerivativePhrases_numberValue', 'a11y.referenceLineTool.accessibleObjectResponse.phrases.secondDerivativePhrases.numberValueStringProperty' );
addToMapIfDefined( 'a11y_referenceLineTool_accessibleObjectResponse_phrases_secondDerivativePhrases_undefined', 'a11y.referenceLineTool.accessibleObjectResponse.phrases.secondDerivativePhrases.undefinedStringProperty' );
addToMapIfDefined( 'a11y_referenceLineTool_accessibleObjectResponse_phrases_secondDerivativePhrases_hidden', 'a11y.referenceLineTool.accessibleObjectResponse.phrases.secondDerivativePhrases.hiddenStringProperty' );
  ...
  a11y: {
    ...
    referenceLineTool: {
      ...
      accessibleObjectResponse: {
        patterns: new FluentPattern<{ derivativePhrase: FluentVariable, graphSet: 'primaryDerivative' | 'integralPrimary' | 'integralPrimaryDerivative' | 'primaryDerivativeSecondDerivative' | TReadOnlyProperty<'primaryDerivative' | 'integralPrimary' | 'integralPrimaryDerivative' | 'primaryDerivativeSecondDerivative'>, integralPhrase: FluentVariable, primaryPhrase: FluentVariable, secondDerivativePhrase: FluentVariable, variable: FluentVariable, xValue: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_patterns', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.patternsStringProperty' ), [{"name":"derivativePhrase"},{"name":"graphSet","variants":["primaryDerivative","integralPrimary","integralPrimaryDerivative","primaryDerivativeSecondDerivative"]},{"name":"integralPhrase"},{"name":"primaryPhrase"},{"name":"secondDerivativePhrase"},{"name":"variable"},{"name":"xValue"}] ),
        phrases: {
          primaryPhrases: {
            primaryValue: new FluentPattern<{ value: FluentVariable, variable: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_phrases_primaryPhrases_primaryValue', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.phrases.primaryPhrases.primaryValueStringProperty' ), [{"name":"value"},{"name":"variable"}] ),
            primaryUndefined: new FluentPattern<{ variable: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_phrases_primaryPhrases_primaryUndefined', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.phrases.primaryPhrases.primaryUndefinedStringProperty' ), [{"name":"variable"}] ),
            primaryHiddenStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_phrases_primaryPhrases_primaryHidden', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.phrases.primaryPhrases.primaryHiddenStringProperty' ) ),
            predictValue: new FluentPattern<{ value: FluentVariable, variable: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_phrases_primaryPhrases_predictValue', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.phrases.primaryPhrases.predictValueStringProperty' ), [{"name":"value"},{"name":"variable"}] ),
            predictUndefined: new FluentPattern<{ variable: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_phrases_primaryPhrases_predictUndefined', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.phrases.primaryPhrases.predictUndefinedStringProperty' ), [{"name":"variable"}] ),
            predictHiddenStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_phrases_primaryPhrases_predictHidden', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.phrases.primaryPhrases.predictHiddenStringProperty' ) ),
            bothCurves: new FluentPattern<{ predictPhrase: FluentVariable, primaryPhrase: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_phrases_primaryPhrases_bothCurves', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.phrases.primaryPhrases.bothCurvesStringProperty' ), [{"name":"predictPhrase"},{"name":"primaryPhrase"}] )
          },
          integralPhrases: {
            numberValue: new FluentPattern<{ value: FluentVariable, variable: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_phrases_integralPhrases_numberValue', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.phrases.integralPhrases.numberValueStringProperty' ), [{"name":"value"},{"name":"variable"}] ),
            hiddenStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_phrases_integralPhrases_hidden', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.phrases.integralPhrases.hiddenStringProperty' ) )
          },
          derivativePhrases: {
            numberValue: new FluentPattern<{ value: FluentVariable, variable: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_phrases_derivativePhrases_numberValue', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.phrases.derivativePhrases.numberValueStringProperty' ), [{"name":"value"},{"name":"variable"}] ),
            undefined: new FluentPattern<{ variable: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_phrases_derivativePhrases_undefined', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.phrases.derivativePhrases.undefinedStringProperty' ), [{"name":"variable"}] ),
            hiddenStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_phrases_derivativePhrases_hidden', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.phrases.derivativePhrases.hiddenStringProperty' ) )
          },
          secondDerivativePhrases: {
            numberValue: new FluentPattern<{ value: FluentVariable, variable: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_phrases_secondDerivativePhrases_numberValue', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.phrases.secondDerivativePhrases.numberValueStringProperty' ), [{"name":"value"},{"name":"variable"}] ),
            undefined: new FluentPattern<{ variable: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_phrases_secondDerivativePhrases_undefined', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.phrases.secondDerivativePhrases.undefinedStringProperty' ), [{"name":"variable"}] ),
            hiddenStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_phrases_secondDerivativePhrases_hidden', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.phrases.secondDerivativePhrases.hiddenStringProperty' ) )
          }
        }
      }
    },
