  ...
  a11y: {
    ...
    referenceLineTool: {
      ...
      accessibleObjectResponse: {
        ...
        patterns: new FluentPattern<{ derivativePhrase: FluentVariable, graphSet: 'primaryDerivative' | 'integralPrimary' | 'integralPrimaryDerivative' | 'primaryDerivativeSecondDerivative' | TReadOnlyProperty<'primaryDerivative' | 'integralPrimary' | 'integralPrimaryDerivative' | 'primaryDerivativeSecondDerivative'>, integralPhrase: FluentVariable, primaryPhrase: FluentVariable, secondDerivativePhrase: FluentVariable, xPhrase: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_referenceLineTool_accessibleObjectResponse_patterns', _.get( CalculusGrapherStrings, 'a11y.referenceLineTool.accessibleObjectResponse.patternsStringProperty' ), [{"name":"derivativePhrase"},{"name":"graphSet","variants":["primaryDerivative","integralPrimary","integralPrimaryDerivative","primaryDerivativeSecondDerivative"]},{"name":"integralPhrase"},{"name":"primaryPhrase"},{"name":"secondDerivativePhrase"},{"name":"xPhrase"}] ),
