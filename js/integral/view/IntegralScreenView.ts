  ...
  public constructor( model: IntegralModel, providedOptions: IntroScreenViewOptions ) {
    ...
    Multilink.multilink( [ this.graphsNode.boundsProperty, netSignedAreaAccordionBox.boundsProperty ],
      () => {
        ...
        netSignedAreaAccordionBox.top = this.graphsNode.y + this.graphsNode.primaryGraphNode.y;
      } );
    ...
    this.setScreenSummaryContent( new IntegralScreenSummaryContent( model.curveManipulationProperties, this.graphsNode ) );
  }
