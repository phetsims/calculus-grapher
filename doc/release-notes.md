# Calculus Grapher - Release Notes
<!-- 
Instructions:
...
* Basic Sound
* Core Description
* Curve manipulation now supports mouse, touch, and keyboard input. In addition to pressing anywhere in the graph to modify _f(x)_ or the Predict curve,
